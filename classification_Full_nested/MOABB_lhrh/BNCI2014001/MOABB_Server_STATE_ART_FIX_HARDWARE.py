...
path_ = "/home/icarrara/Documents/Project/reduced_dataset/classification_Full_nested/MOABB_lhrh/" + dataset_name
path = os.path.join(path_, "FIX_STATE_ART_Subject_" + str(param[0]))
