...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
path = "classification_Full_nested/MOABB_rf/BNCI2014002"
score = "score"
...
results13 = pd.read_csv(os.path.join(path, "STATE_ART_Subject_13/results.cvs"))
results14 = pd.read_csv(os.path.join(path, "STATE_ART_Subject_14/results.cvs"))
frames = [results1, results2, results3, results4, results5, results6, results7, results8, results9,
          results10, results11, results12, results13, results14]
...
results13 = pd.read_csv(os.path.join(path, "MDOP_Subject_13/results.cvs"))
results14 = pd.read_csv(os.path.join(path, "MDOP_Subject_14/results.cvs"))
frames = [results1, results2, results3, results4, results5, results6, results7, results8, results9,
          results10, results11, results12, results13, results14]
...
results13 = pd.read_csv(os.path.join(path, "STATE_ART_DL_Subject_13/results.cvs"))
results14 = pd.read_csv(os.path.join(path, "STATE_ART_DL_Subject_14/results.cvs"))
frames = [results1, results2, results3, results4, results5, results6, results7, results8, results9,
          results10, results11, results12, results13, results14]
