...
path_ = "/home/icarrara/Documents/Project/reduced_dataset/classification_Full_nested/MOABB_rf_CS/" + dataset_name
...
with tf.device('/device:GPU:0'):
    ...
    evaluation_online = CrossSessionEvaluation(paradigm=paradigm,
                                               datasets=dataset,
                                               overwrite=False,
                                               random_state=42,
                                               hdf5_path=path,
